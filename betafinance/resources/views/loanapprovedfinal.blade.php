    ...
    <div class='sample-container'>
            ...
            <div class='sample-content'>
                ...
                <span id="boot-icon" class="bi bi-check-circle-fill" style="font-size: 130px; color: rgb(60, 179, 113);"></span>
                    <h5>Congratulations!<br>Your loan has been approved.<br> A confirmation<br> message has been sent to your Email/Phone</h5>

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img src="{{ asset('image/BetaFinanceLogoWhite.png') }}" class="img-responsive center-block d-block mx-auto" height="100" width="100"  alt="Sample Image">
                </div>
            </div>
        </div>
                ...
                <!-- Form -->
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class=" col-sm-4">
                                <select class="custom-select" id="identity" name="identity">
